...
import Exercici_9.Modules.Users.Model.Utils.Functions_Data_Users;
	...
	public static Class_user update_users_generic(Class_user u) {
		...
		if (u instanceof User) {
			...
			case "Sex":
				...
				break;
			case "DNI":
				functions_find.set_userregisterDNI(u);
				break;
		...
		if (u instanceof Client) {
			...
			case "Sex":
				...
				break;
			case "DNI":
				functions_find.set_clientDNI(u);
				break;
