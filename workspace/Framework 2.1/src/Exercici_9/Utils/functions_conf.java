...
public class functions_conf {
	...
	public static void file () {
		...
		menu = menus.menucombo(tipo7, languages.getInstance().getProperty("filem"), languages.getInstance().getProperty("filet"));
		switch (menu) {
			case "json":
	...
	public static void theme () {
		...
		String menu = "";
		menu = menus.menucombo(options, languages.getInstance().getProperty("Themmessage"), languages.getInstance().getProperty("Themetittle") );
		switch (menu){
